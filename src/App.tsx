...
export default function App() {
  ...
  return (
    <div className="min-h-[100svh] lg:h-screen lg:w-screen bg-dark-bg text-white font-sans selection:bg-f1-red selection:text-white lg:overflow-hidden flex flex-col relative">
      ...
      {/* Mobile Header */}
      <header className="lg:hidden flex items-center justify-center p-4 border-b border-dark-border bg-dark-bg carbon-pattern relative z-20">
          ...
          <AnimatePresence mode="wait">
            {!selectedSession ? (
              ...
              <div className="mb-4 flex flex-col items-center text-center lg:flex-row lg:items-end lg:text-left justify-between gap-4">
                ...
                <div className={cn("shrink-0 lg:h-auto lg:flex-1 lg:min-h-0 border border-dark-border p-2 lg:p-4 bg-dark-surface/30 rounded-xl lg:rounded-lg relative overflow-hidden flex flex-col no-scrollbar", viewMode === 'single' ? "h-[500px]" : "min-h-[500px] h-auto")}>
